...
const CV_URL = `${process.env.PUBLIC_URL}/THISARA-CV.pdf`
...
function Nav() {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-sm px-4 sm:px-6 md:px-10 py-4 md:py-5 transition-colors duration-300 ease-out ${
    ...
    >
      <div className="max-w-[1600px] mx-auto flex items-center justify-between">
        ...
        {/* Right side - Book a Call, CV (desktop) + Burger (mobile) */}
