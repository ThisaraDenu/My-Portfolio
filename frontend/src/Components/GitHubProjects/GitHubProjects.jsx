...
function GitHubProjects() {
  ...
  return (
    <section id="github-projects" className="w-full py-20 px-4 sm:px-6 md:px-8 bg-white">
      <div className="max-w-[1600px] mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4">Latest Code</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <motion.a
              ...
              className="block p-6 rounded-xl border border-gray-200 hover:border-gray-900 bg-[#f9f9f9] transition-all duration-300 group"
            >
        ...
        <div className="mt-12 text-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center justify-center px-8 py-3 rounded-full bg-gray-900 text-white font-medium hover:scale-105 transition-transform duration-300"
          >
            View all on GitHub
          </a>
        </div>
